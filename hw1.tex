...
\begin{align*}
\text{Discrete:}\\
A(n+1) &= \frac{1}{2}A(n) + 24 \\
   -A(n) &= -A(n) \\
A(n+1) - A(n) &= -\frac{1}{2}A(n) + 24 \\
\text{Continuous:}\\
A(t + \Delta t) - A(t) &= (-\frac{1}{2}A(\Delta t) + 24) \Delta t \\
\frac{A(t + \Delta t) - A(t)}{A(\Delta t)} &= \frac{(-\frac{1}{2}A(\Delta t) + 24) \Delta t}{\Delta t} \\
\lim\limits_{\Delta \rightarrow 0} \frac{A(t + \Delta t) - A(t)}{A(\Delta t)} &= \lim\limits_{\Delta \rightarrow 0} \frac{(-\frac{1}{2}A(\Delta t) + 24) \Delta t}{A(\Delta t)} \\
